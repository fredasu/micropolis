...
public class NoMoneyDialog extends JDialog
{
	Micropolis engine;

	static ResourceBundle strings = MainWindow.strings;

	public NoMoneyDialog(Window owner, Micropolis engine)
	{
		super(owner);
	...
	private JComponent makeMessagePane()
	{
		...
		JLabel thLbl = new JLabel(strings.getString("gameOverDlg.nomoney"));
